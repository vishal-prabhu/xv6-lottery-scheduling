...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       6:	a1 a0 63 00 00       	mov    0x63a0,%eax
       b:	c7 44 24 04 d6 44 00 	movl   $0x44d6,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 9b 40 00 00       	call   40b6 <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 e1 44 00 00 	movl   $0x44e1,(%esp)
      22:	e8 f6 3e 00 00       	call   3f1d <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 a0 63 00 00       	mov    0x63a0,%eax
      30:	c7 44 24 04 e9 44 00 	movl   $0x44e9,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 76 40 00 00       	call   40b6 <printf>
    exit();
      40:	e8 70 3e 00 00       	call   3eb5 <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 e1 44 00 00 	movl   $0x44e1,(%esp)
      4c:	e8 d4 3e 00 00       	call   3f25 <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 a0 63 00 00       	mov    0x63a0,%eax
      5a:	c7 44 24 04 f7 44 00 	movl   $0x44f7,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 4c 40 00 00       	call   40b6 <printf>
    exit();
      6a:	e8 46 3e 00 00       	call   3eb5 <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 0d 45 00 00 	movl   $0x450d,(%esp)
      76:	e8 8a 3e 00 00       	call   3f05 <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 a0 63 00 00       	mov    0x63a0,%eax
      84:	c7 44 24 04 18 45 00 	movl   $0x4518,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 22 40 00 00       	call   40b6 <printf>
    exit();
      94:	e8 1c 3e 00 00       	call   3eb5 <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 32 45 00 00 	movl   $0x4532,(%esp)
      a0:	e8 80 3e 00 00       	call   3f25 <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 a0 63 00 00       	mov    0x63a0,%eax
      ae:	c7 44 24 04 34 45 00 	movl   $0x4534,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 f8 3f 00 00       	call   40b6 <printf>
    exit();
      be:	e8 f2 3d 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 a0 63 00 00       	mov    0x63a0,%eax
      c8:	c7 44 24 04 44 45 00 	movl   $0x4544,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 de 3f 00 00       	call   40b6 <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 a0 63 00 00       	mov    0x63a0,%eax
      e5:	c7 44 24 04 52 45 00 	movl   $0x4552,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 c1 3f 00 00       	call   40b6 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 a0 63 00 00       	mov    0x63a0,%eax
     108:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 9e 3f 00 00       	call   40b6 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 e1 44 00 00 	movl   $0x44e1,(%esp)
     12e:	e8 ea 3d 00 00       	call   3f1d <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 a0 63 00 00       	mov    0x63a0,%eax
     13c:	c7 44 24 04 e9 44 00 	movl   $0x44e9,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 6a 3f 00 00       	call   40b6 <printf>
      exit();
     14c:	e8 64 3d 00 00       	call   3eb5 <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 e1 44 00 00 	movl   $0x44e1,(%esp)
     158:	e8 c8 3d 00 00       	call   3f25 <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 a0 63 00 00       	mov    0x63a0,%eax
     166:	c7 44 24 04 6e 45 00 	movl   $0x456e,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 40 3f 00 00       	call   40b6 <printf>
      exit();
     176:	e8 3a 3d 00 00       	call   3eb5 <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 0d 45 00 00 	movl   $0x450d,(%esp)
     182:	e8 7e 3d 00 00       	call   3f05 <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 a0 63 00 00       	mov    0x63a0,%eax
     190:	c7 44 24 04 18 45 00 	movl   $0x4518,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 16 3f 00 00       	call   40b6 <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 a0 63 00 00       	mov    0x63a0,%eax
     1b4:	c7 44 24 04 82 45 00 	movl   $0x4582,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 f2 3e 00 00       	call   40b6 <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 a0 63 00 00       	mov    0x63a0,%eax
     1d1:	c7 44 24 04 94 45 00 	movl   $0x4594,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 d5 3e 00 00       	call   40b6 <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 a3 45 00 00 	movl   $0x45a3,(%esp)
     1e8:	e8 30 3d 00 00       	call   3f1d <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 a0 63 00 00       	mov    0x63a0,%eax
     1f6:	c7 44 24 04 a9 45 00 	movl   $0x45a9,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 b0 3e 00 00       	call   40b6 <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 a0 63 00 00       	mov    0x63a0,%eax
     21e:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 88 3e 00 00       	call   40b6 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 a3 45 00 00 	movl   $0x45a3,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 a0 63 00 00       	mov    0x63a0,%eax
     25b:	c7 44 24 04 c0 45 00 	movl   $0x45c0,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 4b 3e 00 00       	call   40b6 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 a3 45 00 00 	movl   $0x45a3,(%esp)
     288:	e8 78 3c 00 00       	call   3f05 <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 a0 63 00 00       	mov    0x63a0,%eax
     296:	c7 44 24 04 e4 45 00 	movl   $0x45e4,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 10 3e 00 00       	call   40b6 <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 a0 63 00 00       	mov    0x63a0,%eax
     2b5:	c7 44 24 04 f3 45 00 	movl   $0x45f3,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 f1 3d 00 00       	call   40b6 <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 a0 63 00 00       	mov    0x63a0,%eax
     2d2:	c7 44 24 04 05 46 00 	movl   $0x4605,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 d4 3d 00 00       	call   40b6 <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 c0 44 00 00 	movl   $0x44c0,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 a0 63 00 00       	mov    0x63a0,%eax
     304:	c7 44 24 04 10 46 00 	movl   $0x4610,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 a2 3d 00 00       	call   40b6 <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 23 46 00 00 	movl   $0x4623,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 a0 63 00 00       	mov    0x63a0,%eax
     346:	c7 44 24 04 30 46 00 	movl   $0x4630,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 60 3d 00 00       	call   40b6 <printf>
    exit();
     356:	e8 5a 3b 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 a0 63 00 00       	mov    0x63a0,%eax
     360:	c7 44 24 04 4e 46 00 	movl   $0x464e,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 46 3d 00 00       	call   40b6 <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 a0 63 00 00       	mov    0x63a0,%eax
     37d:	c7 44 24 04 5c 46 00 	movl   $0x465c,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 29 3d 00 00       	call   40b6 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 6d 46 00 00 	movl   $0x466d,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 a0 63 00 00       	mov    0x63a0,%eax
     3af:	c7 44 24 04 73 46 00 	movl   $0x4673,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 f7 3c 00 00       	call   40b6 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 a0 63 00 00       	mov    0x63a0,%eax
     3d0:	c7 44 24 04 8e 46 00 	movl   $0x468e,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 d6 3c 00 00       	call   40b6 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 aa 46 00 	movl   $0x46aa,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 a0 63 00 00       	mov    0x63a0,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 b8 46 00 	movl   $0x46b8,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 95 3c 00 00       	call   40b6 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 dc 46 00 	movl   $0x46dc,0x4(%esp)
     435:	00 
     ...
     446:	a1 a0 63 00 00       	mov    0x63a0,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 e8 46 00 	movl   $0x46e8,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 54 3c 00 00       	call   40b6 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     475:	a1 a0 63 00 00       	mov    0x63a0,%eax
     47a:	c7 44 24 04 0c 47 00 	movl   $0x470c,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 2c 3c 00 00       	call   40b6 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49c:	00 
     49d:	c7 04 24 6d 46 00 00 	movl   $0x466d,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b2:	a1 a0 63 00 00       	mov    0x63a0,%eax
     4b7:	c7 44 24 04 17 47 00 	movl   $0x4717,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 ef 3b 00 00       	call   40b6 <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     4ce:	00 
     4cf:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
     4d6:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4f0:	a1 a0 63 00 00       	mov    0x63a0,%eax
     4f5:	c7 44 24 04 30 47 00 	movl   $0x4730,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 b1 3b 00 00       	call   40b6 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     50a:	a1 a0 63 00 00       	mov    0x63a0,%eax
     50f:	c7 44 24 04 4b 47 00 	movl   $0x474b,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 97 3b 00 00       	call   40b6 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     52a:	c7 04 24 6d 46 00 00 	movl   $0x466d,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53c:	a1 a0 63 00 00       	mov    0x63a0,%eax
     541:	c7 44 24 04 5e 47 00 	movl   $0x475e,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 65 3b 00 00       	call   40b6 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     556:	a1 a0 63 00 00       	mov    0x63a0,%eax
     55b:	c7 44 24 04 6b 47 00 	movl   $0x476b,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 4b 3b 00 00       	call   40b6 <printf>
    exit();
     56b:	e8 45 39 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 a0 63 00 00       	mov    0x63a0,%eax
     575:	c7 44 24 04 80 47 00 	movl   $0x4780,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 31 3b 00 00       	call   40b6 <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58d:	a1 a0 63 00 00       	mov    0x63a0,%eax
     592:	c7 44 24 04 94 47 00 	movl   $0x4794,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 14 3b 00 00       	call   40b6 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 a4 47 00 00 	movl   $0x47a4,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5bf:	a1 a0 63 00 00       	mov    0x63a0,%eax
     5c4:	c7 44 24 04 a8 47 00 	movl   $0x47a8,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 e2 3a 00 00       	call   40b6 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60e:	a1 a0 63 00 00       	mov    0x63a0,%eax
     613:	8b 55 f4             	mov    -0xc(%ebp),%edx
     616:	89 54 24 08          	mov    %edx,0x8(%esp)
     61a:	c7 44 24 04 c2 47 00 	movl   $0x47c2,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 8c 3a 00 00       	call   40b6 <printf>
      exit();
  ...
  fd = open("big", O_RDONLY);
     ...
     64f:	00 
     650:	c7 04 24 a4 47 00 00 	movl   $0x47a4,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     665:	a1 a0 63 00 00       	mov    0x63a0,%eax
     66a:	c7 44 24 04 e0 47 00 	movl   $0x47e0,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 3c 3a 00 00       	call   40b6 <printf>
    exit();
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     68d:	00 
     68e:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
     695:	00 
    ...
    if(i == 0){
     ...
     6b3:	a1 a0 63 00 00       	mov    0x63a0,%eax
     6b8:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bb:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bf:	c7 44 24 04 f9 47 00 	movl   $0x47f9,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 e7 39 00 00       	call   40b6 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6e0:	c7 04 24 a4 47 00 00 	movl   $0x47a4,(%esp)
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     761:	a1 a0 63 00 00       	mov    0x63a0,%eax
     766:	c7 44 24 04 48 48 00 	movl   $0x4848,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 40 39 00 00       	call   40b6 <printf>
    exit();
     776:	e8 3a 37 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 a0 63 00 00       	mov    0x63a0,%eax
     780:	c7 44 24 04 5b 48 00 	movl   $0x485b,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 26 39 00 00       	call   40b6 <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     798:	a1 a0 63 00 00       	mov    0x63a0,%eax
     79d:	c7 44 24 04 6c 48 00 	movl   $0x486c,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 09 39 00 00       	call   40b6 <printf>

  name[0] = 'a';
     7ad:	c6 05 80 ab 00 00 61 	movb   $0x61,0xab80
  name[2] = '\0';
     7b4:	c6 05 82 ab 00 00 00 	movb   $0x0,0xab82
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     7ca:	a2 81 ab 00 00       	mov    %al,0xab81
    fd = open(name, O_CREATE|O_RDWR);
     7cf:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     7d6:	00 
     7d7:	c7 04 24 80 ab 00 00 	movl   $0xab80,(%esp)
  ...
  name[0] = 'a';
     7fb:	c6 05 80 ab 00 00 61 	movb   $0x61,0xab80
  name[2] = '\0';
     802:	c6 05 82 ab 00 00 00 	movb   $0x0,0xab82
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     818:	a2 81 ab 00 00       	mov    %al,0xab81
    unlink(name);
     81d:	c7 04 24 80 ab 00 00 	movl   $0xab80,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     833:	a1 a0 63 00 00       	mov    0x63a0,%eax
     838:	c7 44 24 04 94 48 00 	movl   $0x4894,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 6e 38 00 00       	call   40b6 <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     850:	a1 a0 63 00 00       	mov    0x63a0,%eax
     855:	c7 44 24 04 ba 48 00 	movl   $0x48ba,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 51 38 00 00       	call   40b6 <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 c6 48 00 00 	movl   $0x48c6,(%esp)
     86c:	e8 ac 36 00 00       	call   3f1d <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 a0 63 00 00       	mov    0x63a0,%eax
     87a:	c7 44 24 04 e9 44 00 	movl   $0x44e9,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 2c 38 00 00       	call   40b6 <printf>
    exit();
     88a:	e8 26 36 00 00       	call   3eb5 <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 c6 48 00 00 	movl   $0x48c6,(%esp)
     896:	e8 8a 36 00 00       	call   3f25 <chdir>
     89b:	85 c0                	test   %eax,%eax
     89d:	79 1a                	jns    8b9 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89f:	a1 a0 63 00 00       	mov    0x63a0,%eax
     8a4:	c7 44 24 04 cb 48 00 	movl   $0x48cb,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 02 38 00 00       	call   40b6 <printf>
    exit();
     8b4:	e8 fc 35 00 00       	call   3eb5 <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 de 48 00 00 	movl   $0x48de,(%esp)
     8c0:	e8 60 36 00 00       	call   3f25 <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 a0 63 00 00       	mov    0x63a0,%eax
     8ce:	c7 44 24 04 e1 48 00 	movl   $0x48e1,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 d8 37 00 00       	call   40b6 <printf>
    exit();
     8de:	e8 d2 35 00 00       	call   3eb5 <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 c6 48 00 00 	movl   $0x48c6,(%esp)
     8ea:	e8 16 36 00 00       	call   3f05 <unlink>
     8ef:	85 c0                	test   %eax,%eax
     8f1:	79 1a                	jns    90d <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f3:	a1 a0 63 00 00       	mov    0x63a0,%eax
     8f8:	c7 44 24 04 f2 48 00 	movl   $0x48f2,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 ae 37 00 00       	call   40b6 <printf>
    exit();
     908:	e8 a8 35 00 00       	call   3eb5 <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 a0 63 00 00       	mov    0x63a0,%eax
     912:	c7 44 24 04 06 49 00 	movl   $0x4906,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 94 37 00 00       	call   40b6 <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     92a:	a1 a0 63 00 00       	mov    0x63a0,%eax
     92f:	c7 44 24 04 15 49 00 	movl   $0x4915,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 77 37 00 00       	call   40b6 <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 8c 63 00 	movl   $0x638c,0x4(%esp)
     946:	00 
     947:	c7 04 24 c0 44 00 00 	movl   $0x44c0,(%esp)
     94e:	e8 9a 35 00 00       	call   3eed <exec>
     953:	85 c0                	test   %eax,%eax
     955:	79 1a                	jns    971 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     957:	a1 a0 63 00 00       	mov    0x63a0,%eax
     95c:	c7 44 24 04 20 49 00 	movl   $0x4920,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 4a 37 00 00       	call   40b6 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 32 49 00 	movl   $0x4932,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 1a 37 00 00       	call   40b6 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     9e3:	81 c2 80 8b 00 00    	add    $0x8b80,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a02:	00 
     a03:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
     a0a:	00 
     ...
     a1a:	c7 44 24 04 41 49 00 	movl   $0x4941,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 88 36 00 00       	call   40b6 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a73:	05 80 8b 00 00       	add    $0x8b80,%eax
     ...
     a90:	c7 44 24 04 4f 49 00 	movl   $0x494f,0x4(%esp)
     a97:	00 
     a98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9f:	e8 12 36 00 00       	call   40b6 <printf>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ad9:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
     ae0:	00 
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 5d 49 00 	movl   $0x495d,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 9c 35 00 00       	call   40b6 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 83 49 00 	movl   $0x4983,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 73 35 00 00       	call   40b6 <printf>
    ...
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 74 49 00 	movl   $0x4974,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 5d 35 00 00       	call   40b6 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 8d 49 00 	movl   $0x498d,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 3c 35 00 00       	call   40b6 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc8:	00 
     bc9:	c7 44 24 04 97 49 00 	movl   $0x4997,0x4(%esp)
     bd0:	00 
     ...
     bde:	c7 44 24 04 99 49 00 	movl   $0x4999,0x4(%esp)
     be5:	00 
     be6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bed:	e8 c4 34 00 00       	call   40b6 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c14:	00 
     c15:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
     c1c:	00 
    ...
    printf(1, "preempt read error");
     c2a:	c7 44 24 04 ad 49 00 	movl   $0x49ad,0x4(%esp)
     c31:	00 
     c32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c39:	e8 78 34 00 00       	call   40b6 <printf>
  ...
  printf(1, "kill... ");
     c4b:	c7 44 24 04 c0 49 00 	movl   $0x49c0,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 57 34 00 00       	call   40b6 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c80:	c7 44 24 04 c9 49 00 	movl   $0x49c9,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 22 34 00 00       	call   40b6 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 d2 49 00 	movl   $0x49d2,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 ff 33 00 00       	call   40b6 <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd4:	79 16                	jns    cec <exitwait+0x33>
      printf(1, "fork failed\n");
     cd6:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
     cdd:	00 
     cde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce5:	e8 cc 33 00 00       	call   40b6 <printf>
      return;
    ...
    if(pid){
     ...
     cfc:	c7 44 24 04 de 49 00 	movl   $0x49de,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 a6 33 00 00       	call   40b6 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 ee 49 00 	movl   $0x49ee,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 81 33 00 00       	call   40b6 <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 fb 49 00 	movl   $0x49fb,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 65 33 00 00       	call   40b6 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 52 36 00 00       	call   43e0 <malloc>
    ...
    while(m1){
     ...
     da7:	e8 fb 34 00 00       	call   42a7 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df7:	e8 ab 34 00 00       	call   42a7 <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 1f 4a 00 	movl   $0x4a1f,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 a6 32 00 00       	call   40b6 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 27 4a 00 	movl   $0x4a27,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 80 32 00 00       	call   40b6 <printf>

  unlink("sharedfd");
     e36:	c7 04 24 36 4a 00 00 	movl   $0x4a36,(%esp)
     e3d:	e8 c3 30 00 00       	call   3f05 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 36 4a 00 00 	movl   $0x4a36,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 40 4a 00 	movl   $0x4a40,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 43 32 00 00       	call   40b6 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed1:	c7 44 24 04 6c 4a 00 	movl   $0x4a6c,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 d1 31 00 00       	call   40b6 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f16:	00 
     f17:	c7 04 24 36 4a 00 00 	movl   $0x4a36,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 8c 4a 00 	movl   $0x4a8c,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 76 31 00 00       	call   40b6 <printf>
    return;
  ...
  unlink("sharedfd");
     fbd:	c7 04 24 36 4a 00 00 	movl   $0x4a36,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 b7 4a 00 	movl   $0x4ab7,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 c7 30 00 00       	call   40b6 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 c4 4a 00 	movl   $0x4ac4,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 a3 30 00 00       	call   40b6 <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 d9 4a 00 00 	movl   $0x4ad9,-0x38(%ebp)
    1027:	c7 45 cc dc 4a 00 00 	movl   $0x4adc,-0x34(%ebp)
    102e:	c7 45 d0 df 4a 00 00 	movl   $0x4adf,-0x30(%ebp)
    1035:	c7 45 d4 e2 4a 00 00 	movl   $0x4ae2,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 e5 4a 00 	movl   $0x4ae5,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 66 30 00 00       	call   40b6 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 23 30 00 00       	call   40b6 <printf>
      exit();
    ...
    10be:	c7 44 24 04 f5 4a 00 	movl   $0x4af5,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 e4 2f 00 00       	call   40b6 <printf>
        exit();
    ...
    10e9:	c7 04 24 80 8b 00 00 	movl   $0x8b80,(%esp)
    ...
    1105:	00 
    1106:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
    110d:	00 
    ...
    112c:	c7 44 24 04 04 4b 00 	movl   $0x4b04,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 76 2f 00 00       	call   40b6 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11bb:	05 80 8b 00 00       	add    $0x8b80,%eax
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 15 4b 00 	movl   $0x4b15,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 d2 2e 00 00       	call   40b6 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    1202:	00 
    1203:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
    120a:	00 
    ...
    123a:	c7 44 24 04 21 4b 00 	movl   $0x4b21,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 68 2e 00 00       	call   40b6 <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 32 4b 00 	movl   $0x4b32,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 36 2e 00 00       	call   40b6 <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1288:	c7 44 24 04 40 4b 00 	movl   $0x4b40,0x4(%esp)
    128f:	00 
    1290:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1297:	e8 1a 2e 00 00       	call   40b6 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12b4:	79 19                	jns    12cf <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b6:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
    12bd:	00 
    12be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c5:	e8 ec 2d 00 00       	call   40b6 <printf>
      exit();
    ...
    1315:	79 19                	jns    1330 <createdelete+0xae>
          printf(1, "create failed\n");
    1317:	c7 44 24 04 f5 4a 00 	movl   $0x4af5,0x4(%esp)
    131e:	00 
    131f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1326:	e8 8b 2d 00 00       	call   40b6 <printf>
          exit();
    ...
    136c:	c7 44 24 04 e4 45 00 	movl   $0x45e4,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 36 2d 00 00       	call   40b6 <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1429:	c7 44 24 04 54 4b 00 	movl   $0x4b54,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 79 2c 00 00       	call   40b6 <printf>
        exit();
    ...
    145b:	c7 44 24 04 78 4b 00 	movl   $0x4b78,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 47 2c 00 00       	call   40b6 <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 98 4b 00 	movl   $0x4b98,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 be 2b 00 00       	call   40b6 <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 a9 4b 00 	movl   $0x4ba9,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 a2 2b 00 00       	call   40b6 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1514:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 ba 4b 00 00 	movl   $0x4bba,(%esp)
  ...
  if(fd < 0){
    ...
    1531:	c7 44 24 04 c5 4b 00 	movl   $0x4bc5,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 71 2b 00 00       	call   40b6 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1551:	00 
    1552:	c7 44 24 04 df 4b 00 	movl   $0x4bdf,0x4(%esp)
    1559:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1577:	00 
    1578:	c7 04 24 ba 4b 00 00 	movl   $0x4bba,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1613:	00 
    1614:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
    161b:	00 
    ...
    162c:	c7 44 24 04 1b 4c 00 	movl   $0x4c1b,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 76 2a 00 00       	call   40b6 <printf>
    exit();
    1640:	e8 70 28 00 00       	call   3eb5 <exit>
  }
  if(buf[0] != 'h'){
    1645:	0f b6 05 80 8b 00 00 	movzbl 0x8b80,%eax
    164c:	3c 68                	cmp    $0x68,%al
    164e:	74 19                	je     1669 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    1650:	c7 44 24 04 32 4c 00 	movl   $0x4c32,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 52 2a 00 00       	call   40b6 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1670:	00 
    1671:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
    1678:	00 
    ...
    1689:	c7 44 24 04 49 4c 00 	movl   $0x4c49,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 19 2a 00 00       	call   40b6 <printf>
    exit();
  ...
  unlink("unlinkread");
    16ad:	c7 04 24 ba 4b 00 00 	movl   $0x4bba,(%esp)
    16b4:	e8 4c 28 00 00       	call   3f05 <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 62 4c 00 	movl   $0x4c62,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 e9 29 00 00       	call   40b6 <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 71 4c 00 	movl   $0x4c71,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 cd 29 00 00       	call   40b6 <printf>

  unlink("lf1");
    16e9:	c7 04 24 7b 4c 00 00 	movl   $0x4c7b,(%esp)
    16f0:	e8 10 28 00 00       	call   3f05 <unlink>
  unlink("lf2");
    16f5:	c7 04 24 7f 4c 00 00 	movl   $0x4c7f,(%esp)
    16fc:	e8 04 28 00 00       	call   3f05 <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 7b 4c 00 00 	movl   $0x4c7b,(%esp)
  ...
  if(fd < 0){
    ...
    171e:	c7 44 24 04 83 4c 00 	movl   $0x4c83,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 84 29 00 00       	call   40b6 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    173e:	00 
    173f:	c7 44 24 04 df 4b 00 	movl   $0x4bdf,0x4(%esp)
    1746:	00 
    ...
    1757:	c7 44 24 04 96 4c 00 	movl   $0x4c96,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 4b 29 00 00       	call   40b6 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17f0:	00 
    17f1:	c7 04 24 7f 4c 00 00 	movl   $0x4c7f,(%esp)
  ...
  if(fd < 0){
    ...
    1806:	c7 44 24 04 e5 4c 00 	movl   $0x4ce5,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 9c 28 00 00       	call   40b6 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1826:	00 
    1827:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
    182e:	00 
    ...
    183f:	c7 44 24 04 f6 4c 00 	movl   $0x4cf6,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 63 28 00 00       	call   40b6 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 7f 4c 00 	movl   $0x4c7f,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 7f 4c 00 00 	movl   $0x4c7f,(%esp)
    1872:	e8 9e 26 00 00       	call   3f15 <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 07 4d 00 	movl   $0x4d07,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 27 28 00 00       	call   40b6 <printf>
    exit();
    188f:	e8 21 26 00 00       	call   3eb5 <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 7f 4c 00 00 	movl   $0x4c7f,(%esp)
    189b:	e8 65 26 00 00       	call   3f05 <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 7b 4c 00 	movl   $0x4c7b,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 7f 4c 00 00 	movl   $0x4c7f,(%esp)
    18af:	e8 61 26 00 00       	call   3f15 <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 28 4d 00 	movl   $0x4d28,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 ea 27 00 00       	call   40b6 <printf>
    exit();
    18cc:	e8 e4 25 00 00       	call   3eb5 <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 7b 4c 00 	movl   $0x4c7b,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 4b 4d 00 00 	movl   $0x4d4b,(%esp)
    18e0:	e8 30 26 00 00       	call   3f15 <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 4d 4d 00 	movl   $0x4d4d,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 b9 27 00 00       	call   40b6 <printf>
    exit();
    18fd:	e8 b3 25 00 00       	call   3eb5 <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 69 4d 00 	movl   $0x4d69,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 a0 27 00 00       	call   40b6 <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 76 4d 00 	movl   $0x4d76,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 84 27 00 00       	call   40b6 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1991:	c7 04 24 86 4d 00 00 	movl   $0x4d86,(%esp)
    ...
    19d4:	c7 04 24 86 4d 00 00 	movl   $0x4d86,(%esp)
    ...
    1a05:	c7 44 24 04 89 4d 00 	movl   $0x4d89,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 9d 26 00 00       	call   40b6 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a69:	00 
    1a6a:	c7 04 24 4b 4d 00 00 	movl   $0x4d4b,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 a5 4d 00 	movl   $0x4da5,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 d6 25 00 00       	call   40b6 <printf>
        exit();
    ...
    1afe:	c7 44 24 04 be 4d 00 	movl   $0x4dbe,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 a4 25 00 00       	call   40b6 <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b59:	c7 44 24 04 dc 4d 00 	movl   $0x4ddc,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 49 25 00 00       	call   40b6 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 0d 25 00 00       	call   40b6 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 0d 4e 00 	movl   $0x4e0d,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 ed 23 00 00       	call   40b6 <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 1b 4e 00 	movl   $0x4e1b,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 d1 23 00 00       	call   40b6 <printf>

  unlink("x");
    1ce5:	c7 04 24 97 49 00 00 	movl   $0x4997,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 a3 23 00 00       	call   40b6 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 97 49 00 00 	movl   $0x4997,(%esp)
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 97 49 00 	movl   $0x4997,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 2c 4e 00 00 	movl   $0x4e2c,(%esp)
    1db0:	e8 60 21 00 00       	call   3f15 <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 97 49 00 00 	movl   $0x4997,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 30 4e 00 	movl   $0x4e30,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 bf 22 00 00       	call   40b6 <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 3f 4e 00 	movl   $0x4e3f,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 a3 22 00 00       	call   40b6 <printf>
  unlink("bd");
    1e13:	c7 04 24 4c 4e 00 00 	movl   $0x4e4c,(%esp)
    1e1a:	e8 e6 20 00 00       	call   3f05 <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 4c 4e 00 00 	movl   $0x4e4c,(%esp)
  ...
  if(fd < 0){
    ...
    1e3c:	c7 44 24 04 4f 4e 00 	movl   $0x4e4f,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 66 22 00 00       	call   40b6 <printf>
    exit();
  ...
  unlink("bd");
    1ed6:	c7 04 24 4c 4e 00 00 	movl   $0x4e4c,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f2a:	c7 44 24 04 79 4e 00 	movl   $0x4e79,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 78 21 00 00       	call   40b6 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 8e 4e 00 	movl   $0x4e8e,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 52 21 00 00       	call   40b6 <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 99 4e 00 	movl   $0x4e99,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 36 21 00 00       	call   40b6 <printf>

  unlink("ff");
    1f80:	c7 04 24 a6 4e 00 00 	movl   $0x4ea6,(%esp)
    1f87:	e8 79 1f 00 00       	call   3f05 <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 a9 4e 00 00 	movl   $0x4ea9,(%esp)
    1f93:	e8 85 1f 00 00       	call   3f1d <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 ac 4e 00 	movl   $0x4eac,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 06 21 00 00       	call   40b6 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbc:	00 
    1fbd:	c7 04 24 c4 4e 00 00 	movl   $0x4ec4,(%esp)
  ...
  if(fd < 0){
    ...
    1fd2:	c7 44 24 04 ca 4e 00 	movl   $0x4eca,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 d0 20 00 00       	call   40b6 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff2:	00 
    1ff3:	c7 44 24 04 a6 4e 00 	movl   $0x4ea6,0x4(%esp)
    1ffa:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    206a:	00 
    206b:	c7 04 24 28 4f 00 00 	movl   $0x4f28,(%esp)
  ...
  if(fd < 0){
    ...
    2080:	c7 44 24 04 31 4f 00 	movl   $0x4f31,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 22 20 00 00       	call   40b6 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    20a0:	00 
    20a1:	c7 44 24 04 49 4f 00 	movl   $0x4f49,0x4(%esp)
    20a8:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c6:	00 
    20c7:	c7 04 24 4c 4f 00 00 	movl   $0x4f4c,(%esp)
  ...
  if(fd < 0){
    ...
    20dc:	c7 44 24 04 58 4f 00 	movl   $0x4f58,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 c6 1f 00 00       	call   40b6 <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    20fc:	00 
    20fd:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
    2104:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2119:	0f b6 05 80 8b 00 00 	movzbl 0x8b80,%eax
    2120:	3c 66                	cmp    $0x66,%al
    2122:	74 19                	je     213d <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    2124:	c7 44 24 04 71 4f 00 	movl   $0x4f71,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 7e 1f 00 00       	call   40b6 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227e:	00 
    227f:	c7 04 24 8c 4f 00 00 	movl   $0x4f8c,(%esp)
  ...
  if(fd < 0){
    ...
    2294:	c7 44 24 04 56 50 00 	movl   $0x5056,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 0e 1e 00 00       	call   40b6 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22b4:	00 
    22b5:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
    22bc:	00 
    ...
    22cd:	c7 44 24 04 6e 50 00 	movl   $0x506e,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 d5 1d 00 00       	call   40b6 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 e8 52 00 	movl   $0x52e8,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 f0 19 00 00       	call   40b6 <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 f7 52 00 00 	movl   $0x52f7,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 f7 52 00 00 	movl   $0x52f7,(%esp)
    ...
    26fb:	c7 44 24 04 00 53 00 	movl   $0x5300,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 a7 19 00 00       	call   40b6 <printf>
      exit();
    ...
    2724:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
    272b:	00 
    ...
    2750:	c7 44 24 04 18 53 00 	movl   $0x5318,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 52 19 00 00       	call   40b6 <printf>
        exit();
    ...
    unlink("bigwrite");
    277e:	c7 04 24 f7 52 00 00 	movl   $0x52f7,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 2a 53 00 	movl   $0x532a,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 04 19 00 00       	call   40b6 <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 37 53 00 	movl   $0x5337,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 e8 18 00 00       	call   40b6 <printf>

  unlink("bigfile");
    27ce:	c7 04 24 45 53 00 00 	movl   $0x5345,(%esp)
    27d5:	e8 2b 17 00 00       	call   3f05 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 45 53 00 00 	movl   $0x5345,(%esp)
  ...
  if(fd < 0){
    ...
    27f7:	c7 44 24 04 4d 53 00 	movl   $0x534d,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 ab 18 00 00       	call   40b6 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2828:	c7 04 24 80 8b 00 00 	movl   $0x8b80,(%esp)
    282f:	e8 d4 14 00 00       	call   3d08 <memset>
    if(write(fd, buf, 600) != 600){
    2834:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    283b:	00 
    283c:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
    2843:	00 
    ...
    2856:	c7 44 24 04 63 53 00 	movl   $0x5363,0x4(%esp)
    285d:	00 
    285e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2865:	e8 4c 18 00 00       	call   40b6 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288b:	00 
    288c:	c7 04 24 45 53 00 00 	movl   $0x5345,(%esp)
  ...
  if(fd < 0){
    ...
    28a1:	c7 44 24 04 79 53 00 	movl   $0x5379,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 01 18 00 00       	call   40b6 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28cf:	00 
    28d0:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
    28d7:	00 
    ...
    28ec:	c7 44 24 04 8e 53 00 	movl   $0x538e,0x4(%esp)
    28f3:	00 
    28f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fb:	e8 b6 17 00 00       	call   40b6 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 a3 53 00 	movl   $0x53a3,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 73 17 00 00       	call   40b6 <printf>
      exit();
    2943:	e8 6d 15 00 00       	call   3eb5 <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    2948:	0f b6 05 80 8b 00 00 	movzbl 0x8b80,%eax
    ...
    2962:	0f b6 05 ab 8c 00 00 	movzbl 0x8cab,%eax
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 b7 53 00 	movl   $0x53b7,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 26 17 00 00       	call   40b6 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    29a4:	c7 44 24 04 d0 53 00 	movl   $0x53d0,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 fe 16 00 00       	call   40b6 <printf>
    exit();
    29b8:	e8 f8 14 00 00       	call   3eb5 <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 45 53 00 00 	movl   $0x5345,(%esp)
    29c4:	e8 3c 15 00 00       	call   3f05 <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 ea 53 00 	movl   $0x53ea,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 d9 16 00 00       	call   40b6 <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a52:	00 
    2a53:	c7 04 24 88 54 00 00 	movl   $0x5488,(%esp)
  ...
  if(fd < 0){
    ...
    2a68:	c7 44 24 04 b8 54 00 	movl   $0x54b8,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 3a 16 00 00       	call   40b6 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a93:	00 
    2a94:	c7 04 24 f8 54 00 00 	movl   $0x54f8,(%esp)
  ...
  if(fd < 0){
    ...
    2aa9:	c7 44 24 04 28 55 00 	movl   $0x5528,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 f9 15 00 00       	call   40b6 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 bf 56 00 	movl   $0x56bf,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 ef 13 00 00       	call   40b6 <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 cc 56 00 00 	movl   $0x56cc,(%esp)
  ...
  if(fd < 0){
    ...
    2ce4:	c7 44 24 04 d4 56 00 	movl   $0x56d4,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 be 13 00 00       	call   40b6 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d38:	00 
    2d39:	c7 04 24 05 57 00 00 	movl   $0x5705,(%esp)
  ...
  if(fd >= 0){
    ...
    2d4e:	c7 44 24 04 10 57 00 	movl   $0x5710,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 54 13 00 00       	call   40b6 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d6e:	00 
    2d6f:	c7 04 24 05 57 00 00 	movl   $0x5705,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e50:	00 
    2e51:	c7 04 24 4b 4d 00 00 	movl   $0x4d4b,(%esp)
  ...
  if(fd >= 0){
    ...
    2e66:	c7 44 24 04 a8 57 00 	movl   $0x57a8,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 3c 12 00 00       	call   40b6 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eb5:	c7 44 24 04 c7 57 00 	movl   $0x57c7,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 ed 11 00 00       	call   40b6 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 db 57 00 	movl   $0x57db,0x4(%esp)
    2ee0:	00 
    2ee1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee8:	e8 c9 11 00 00       	call   40b6 <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 eb 57 00 	movl   $0x57eb,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 ad 11 00 00       	call   40b6 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2fb6:	00 
    2fb7:	c7 04 24 2b 58 00 00 	movl   $0x582b,(%esp)
    ...
    unlink("xx");
    2fd7:	c7 04 24 2b 58 00 00 	movl   $0x582b,(%esp)
  ...
  chdir("/");
    2ff1:	c7 04 24 32 45 00 00 	movl   $0x4532,(%esp)
    2ff8:	e8 28 0f 00 00       	call   3f25 <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 2e 58 00 	movl   $0x582e,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 a5 10 00 00       	call   40b6 <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 42 58 00 	movl   $0x5842,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 89 10 00 00       	call   40b6 <printf>
    ...
    304c:	e8 64 0e 00 00       	call   3eb5 <exit>
{
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 50 58 00 	movl   $0x5850,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 3b 10 00 00       	call   40b6 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    308b:	c7 44 24 04 72 58 00 	movl   $0x5872,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 17 10 00 00       	call   40b6 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b8:	c7 44 24 04 86 58 00 	movl   $0x5886,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 ea 0f 00 00       	call   40b6 <printf>
    exit();
    30cc:	e8 e4 0d 00 00       	call   3eb5 <exit>
  }
  
  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 99 58 00 	movl   $0x5899,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 d1 0f 00 00       	call   40b6 <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30f1:	a1 a0 63 00 00       	mov    0x63a0,%eax
    30f6:	c7 44 24 04 a7 58 00 	movl   $0x58a7,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 b0 0f 00 00       	call   40b6 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    3144:	a1 a0 63 00 00       	mov    0x63a0,%eax
    ...
    315e:	c7 44 24 04 b2 58 00 	movl   $0x58b2,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 48 0f 00 00       	call   40b6 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    319d:	a1 a0 63 00 00       	mov    0x63a0,%eax
    31a2:	c7 44 24 04 cd 58 00 	movl   $0x58cd,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 04 0f 00 00       	call   40b6 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31e0:	a1 a0 63 00 00       	mov    0x63a0,%eax
    31e5:	c7 44 24 04 e4 58 00 	movl   $0x58e4,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 c1 0e 00 00       	call   40b6 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    323e:	a1 a0 63 00 00       	mov    0x63a0,%eax
    3243:	c7 44 24 04 00 59 00 	movl   $0x5900,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 63 0e 00 00       	call   40b6 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3289:	a1 a0 63 00 00       	mov    0x63a0,%eax
    328e:	c7 44 24 04 3e 59 00 	movl   $0x593e,0x4(%esp)
    3295:	00 
    3296:	89 04 24             	mov    %eax,(%esp)
    3299:	e8 18 0e 00 00       	call   40b6 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32bf:	a1 a0 63 00 00       	mov    0x63a0,%eax
    ...
    32d2:	c7 44 24 04 5c 59 00 	movl   $0x595c,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 d4 0d 00 00       	call   40b6 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3326:	a1 a0 63 00 00       	mov    0x63a0,%eax
    ...
    3339:	c7 44 24 04 94 59 00 	movl   $0x5994,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 6d 0d 00 00       	call   40b6 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3358:	a1 a0 63 00 00       	mov    0x63a0,%eax
    335d:	c7 44 24 04 bc 59 00 	movl   $0x59bc,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 49 0d 00 00       	call   40b6 <printf>
    exit();
  ...
  if(c != a){
    ...
    33a7:	a1 a0 63 00 00       	mov    0x63a0,%eax
    ...
    33ba:	c7 44 24 04 ec 59 00 	movl   $0x59ec,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 ec 0c 00 00       	call   40b6 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33ec:	79 1a                	jns    3408 <sbrktest+0x321>
      printf(stdout, "fork failed\n");
    33ee:	a1 a0 63 00 00       	mov    0x63a0,%eax
    33f3:	c7 44 24 04 61 45 00 	movl   $0x4561,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 b3 0c 00 00       	call   40b6 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346f:	c7 44 24 04 32 49 00 	movl   $0x4932,0x4(%esp)
    3476:	00 
    3477:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347e:	e8 33 0c 00 00       	call   40b6 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d2:	00 
    34d3:	c7 44 24 04 97 49 00 	movl   $0x4997,0x4(%esp)
    34da:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3573:	a1 a0 63 00 00       	mov    0x63a0,%eax
    3578:	c7 44 24 04 26 5a 00 	movl   $0x5a26,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 2e 0b 00 00       	call   40b6 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    35b9:	a1 a0 63 00 00       	mov    0x63a0,%eax
    35be:	c7 44 24 04 41 5a 00 	movl   $0x5a41,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 e8 0a 00 00       	call   40b6 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    35ff:	a1 a0 63 00 00       	mov    0x63a0,%eax
    3604:	c7 44 24 04 4f 5a 00 	movl   $0x5a4f,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 a2 0a 00 00       	call   40b6 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3671:	c7 04 24 5e 5a 00 00 	movl   $0x5a5e,(%esp)
    3678:	e8 98 08 00 00       	call   3f15 <link>
    367d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3680:	74 1a                	je     369c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3682:	a1 a0 63 00 00       	mov    0x63a0,%eax
    3687:	c7 44 24 04 69 5a 00 	movl   $0x5a69,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 1f 0a 00 00       	call   40b6 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36af:	a1 a0 63 00 00       	mov    0x63a0,%eax
    36b4:	c7 44 24 04 82 5a 00 	movl   $0x5a82,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 f2 09 00 00       	call   40b6 <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36cc:	a1 a0 63 00 00       	mov    0x63a0,%eax
    36d1:	c7 44 24 04 8f 5a 00 	movl   $0x5a8f,0x4(%esp)
    36d8:	00 
    36d9:	89 04 24             	mov    %eax,(%esp)
    36dc:	e8 d5 09 00 00       	call   40b6 <printf>
  for(i = 0; i < sizeof(uninit); i++){
    36e1:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    36e8:	eb 2d                	jmp    3717 <bsstest+0x51>
    if(uninit[i] != '\0'){
    36ea:	8b 45 f4             	mov    -0xc(%ebp),%eax
    36ed:	05 60 64 00 00       	add    $0x6460,%eax
    36f2:	0f b6 00             	movzbl (%eax),%eax
    36f5:	84 c0                	test   %al,%al
    36f7:	74 1a                	je     3713 <bsstest+0x4d>
      printf(stdout, "bss test failed\n");
    36f9:	a1 a0 63 00 00       	mov    0x63a0,%eax
    36fe:	c7 44 24 04 99 5a 00 	movl   $0x5a99,0x4(%esp)
    3705:	00 
    3706:	89 04 24             	mov    %eax,(%esp)
    3709:	e8 a8 09 00 00       	call   40b6 <printf>
      exit();
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3721:	a1 a0 63 00 00       	mov    0x63a0,%eax
    3726:	c7 44 24 04 aa 5a 00 	movl   $0x5aaa,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 80 09 00 00       	call   40b6 <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 b7 5a 00 00 	movl   $0x5ab7,(%esp)
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 c0 63 00 00 	movl   $0x5ac4,0x63c0(,%eax,4)
    376f:	c4 5a 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    377b:	7e e8                	jle    3765 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    377d:	c7 05 3c 64 00 00 00 	movl   $0x0,0x643c
    3784:	00 00 00 
    printf(stdout, "bigarg test\n");
    3787:	a1 a0 63 00 00       	mov    0x63a0,%eax
    378c:	c7 44 24 04 a1 5b 00 	movl   $0x5ba1,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 1a 09 00 00       	call   40b6 <printf>
    exec("echo", args);
    379c:	c7 44 24 04 c0 63 00 	movl   $0x63c0,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 c0 44 00 00 	movl   $0x44c0,(%esp)
    37ab:	e8 3d 07 00 00       	call   3eed <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 a0 63 00 00       	mov    0x63a0,%eax
    37b5:	c7 44 24 04 ae 5b 00 	movl   $0x5bae,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 f1 08 00 00       	call   40b6 <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 b7 5a 00 00 	movl   $0x5ab7,(%esp)
    ...
    37f2:	a1 a0 63 00 00       	mov    0x63a0,%eax
    37f7:	c7 44 24 04 be 5b 00 	movl   $0x5bbe,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 af 08 00 00       	call   40b6 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3818:	00 
    3819:	c7 04 24 b7 5a 00 00 	movl   $0x5ab7,(%esp)
  ...
  if(fd < 0){
    ...
    382e:	a1 a0 63 00 00       	mov    0x63a0,%eax
    3833:	c7 44 24 04 d7 5b 00 	movl   $0x5bd7,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 73 08 00 00       	call   40b6 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3853:	c7 04 24 b7 5a 00 00 	movl   $0x5ab7,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 ec 5b 00 	movl   $0x5bec,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 33 08 00 00       	call   40b6 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3959:	c7 44 24 04 f9 5b 00 	movl   $0x5bf9,0x4(%esp)
    3960:	00 
    3961:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3968:	e8 49 07 00 00       	call   40b6 <printf>
    ...
    3990:	c7 44 24 04 05 5c 00 	movl   $0x5c05,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 12 07 00 00       	call   40b6 <printf>
      break;
    ...
    39b4:	00 
    39b5:	c7 44 24 04 80 8b 00 	movl   $0x8b80,0x4(%esp)
    39bc:	00 
    ...
    39dc:	c7 44 24 04 15 5c 00 	movl   $0x5c15,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 c6 06 00 00       	call   40b6 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 25 5c 00 	movl   $0x5c25,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 a2 05 00 00       	call   40b6 <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b1d:	a1 a4 63 00 00       	mov    0x63a4,%eax
    3b22:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b28:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b2d:	a3 a4 63 00 00       	mov    %eax,0x63a4
  return randstate;
    3b32:	a1 a4 63 00 00       	mov    0x63a4,%eax
}
    3b37:	5d                   	pop    %ebp
    3b38:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3b8e:	00 
    3b8f:	c7 04 24 4f 5c 00 00 	movl   $0x5c4f,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    3fde:	0f b6 80 a8 63 00 00 	movzbl 0x63a8(%eax),%eax
...
printlong(int fd, unsigned long long xx, int base, int sgn)
{
    ...
    404e:	89 45 e0             	mov    %eax,-0x20(%ebp)
    4051:	8b 45 10             	mov    0x10(%ebp),%eax
    4054:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    // Force hexadecimal
    uint upper, lower;
    upper = xx >> 32;
    4057:	8b 45 e0             	mov    -0x20(%ebp),%eax
    405a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    405d:	89 d0                	mov    %edx,%eax
    405f:	31 d2                	xor    %edx,%edx
    4061:	89 45 f4             	mov    %eax,-0xc(%ebp)
    lower = xx & 0xffffffff;
    4064:	8b 45 e0             	mov    -0x20(%ebp),%eax
    4067:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(upper) printint(fd, upper, 16, 0);
    406a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    406e:	74 22                	je     4092 <printlong+0x4d>
    4070:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4073:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    407a:	00 
    407b:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4082:	00 
    4083:	89 44 24 04          	mov    %eax,0x4(%esp)
    4087:	8b 45 08             	mov    0x8(%ebp),%eax
    408a:	89 04 24             	mov    %eax,(%esp)
    408d:	e8 fb fe ff ff       	call   3f8d <printint>
    printint(fd, lower, 16, 0);
    4092:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4095:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    409c:	00 
    409d:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    40a4:	00 
    40a5:	89 44 24 04          	mov    %eax,0x4(%esp)
    40a9:	8b 45 08             	mov    0x8(%ebp),%eax
    40ac:	89 04 24             	mov    %eax,(%esp)
    40af:	e8 d9 fe ff ff       	call   3f8d <printint>
}
    40b4:	c9                   	leave  
    40b5:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    40b9:	83 ec 48             	sub    $0x48,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    40bc:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    40c3:	8d 45 0c             	lea    0xc(%ebp),%eax
    40c6:	83 c0 04             	add    $0x4,%eax
    40c9:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    40cc:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    40d3:	e9 ba 01 00 00       	jmp    4292 <printf+0x1dc>
    c = fmt[i] & 0xff;
    40d8:	8b 55 0c             	mov    0xc(%ebp),%edx
    40db:	8b 45 f0             	mov    -0x10(%ebp),%eax
    40de:	01 d0                	add    %edx,%eax
    40e0:	0f b6 00             	movzbl (%eax),%eax
    40e3:	0f be c0             	movsbl %al,%eax
    40e6:	25 ff 00 00 00       	and    $0xff,%eax
    40eb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    40ee:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    40f2:	75 2c                	jne    4120 <printf+0x6a>
      if(c == '%'){
    40f4:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    40f8:	75 0c                	jne    4106 <printf+0x50>
        state = '%';
    40fa:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    4101:	e9 88 01 00 00       	jmp    428e <printf+0x1d8>
      } else {
        putc(fd, c);
    4106:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4109:	0f be c0             	movsbl %al,%eax
    410c:	89 44 24 04          	mov    %eax,0x4(%esp)
    4110:	8b 45 08             	mov    0x8(%ebp),%eax
    4113:	89 04 24             	mov    %eax,(%esp)
    4116:	e8 4a fe ff ff       	call   3f65 <putc>
    411b:	e9 6e 01 00 00       	jmp    428e <printf+0x1d8>
      }
    } else if(state == '%'){
    4120:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    4124:	0f 85 64 01 00 00    	jne    428e <printf+0x1d8>
      if(c == 'd'){
    412a:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    412e:	75 2d                	jne    415d <printf+0xa7>
        printint(fd, *ap, 10, 1);
    4130:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4133:	8b 00                	mov    (%eax),%eax
    4135:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    413c:	00 
    413d:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    4144:	00 
    4145:	89 44 24 04          	mov    %eax,0x4(%esp)
    4149:	8b 45 08             	mov    0x8(%ebp),%eax
    414c:	89 04 24             	mov    %eax,(%esp)
    414f:	e8 39 fe ff ff       	call   3f8d <printint>
        ap++;
    4154:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4158:	e9 2a 01 00 00       	jmp    4287 <printf+0x1d1>
      } else if(c == 'l') {
    415d:	83 7d e4 6c          	cmpl   $0x6c,-0x1c(%ebp)
    4161:	75 38                	jne    419b <printf+0xe5>
        printlong(fd, *(unsigned long long *)ap, 10, 0);
    4163:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4166:	8b 50 04             	mov    0x4(%eax),%edx
    4169:	8b 00                	mov    (%eax),%eax
    416b:	c7 44 24 10 00 00 00 	movl   $0x0,0x10(%esp)
    4172:	00 
    4173:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
    417a:	00 
    417b:	89 44 24 04          	mov    %eax,0x4(%esp)
    417f:	89 54 24 08          	mov    %edx,0x8(%esp)
    4183:	8b 45 08             	mov    0x8(%ebp),%eax
    4186:	89 04 24             	mov    %eax,(%esp)
    4189:	e8 b7 fe ff ff       	call   4045 <printlong>
        // long longs take up 2 argument slots
        ap++;
    418e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        ap++;
    4192:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4196:	e9 ec 00 00 00       	jmp    4287 <printf+0x1d1>
      } else if(c == 'x' || c == 'p'){
    419b:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    419f:	74 06                	je     41a7 <printf+0xf1>
    41a1:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    41a5:	75 2d                	jne    41d4 <printf+0x11e>
        printint(fd, *ap, 16, 0);
    41a7:	8b 45 e8             	mov    -0x18(%ebp),%eax
    41aa:	8b 00                	mov    (%eax),%eax
    41ac:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    41b3:	00 
    41b4:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    41bb:	00 
    41bc:	89 44 24 04          	mov    %eax,0x4(%esp)
    41c0:	8b 45 08             	mov    0x8(%ebp),%eax
    41c3:	89 04 24             	mov    %eax,(%esp)
    41c6:	e8 c2 fd ff ff       	call   3f8d <printint>
        ap++;
    41cb:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    41cf:	e9 b3 00 00 00       	jmp    4287 <printf+0x1d1>
      } else if(c == 's'){
    41d4:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    41d8:	75 45                	jne    421f <printf+0x169>
        s = (char*)*ap;
    41da:	8b 45 e8             	mov    -0x18(%ebp),%eax
    41dd:	8b 00                	mov    (%eax),%eax
    41df:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    41e2:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    41e6:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    41ea:	75 09                	jne    41f5 <printf+0x13f>
          s = "(null)";
    41ec:	c7 45 f4 8a 5c 00 00 	movl   $0x5c8a,-0xc(%ebp)
        while(*s != 0){
    41f3:	eb 1e                	jmp    4213 <printf+0x15d>
    41f5:	eb 1c                	jmp    4213 <printf+0x15d>
          putc(fd, *s);
    41f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    41fa:	0f b6 00             	movzbl (%eax),%eax
    41fd:	0f be c0             	movsbl %al,%eax
    4200:	89 44 24 04          	mov    %eax,0x4(%esp)
    4204:	8b 45 08             	mov    0x8(%ebp),%eax
    4207:	89 04 24             	mov    %eax,(%esp)
    420a:	e8 56 fd ff ff       	call   3f65 <putc>
          s++;
    420f:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    4213:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4216:	0f b6 00             	movzbl (%eax),%eax
    4219:	84 c0                	test   %al,%al
    421b:	75 da                	jne    41f7 <printf+0x141>
    421d:	eb 68                	jmp    4287 <printf+0x1d1>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    421f:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    4223:	75 1d                	jne    4242 <printf+0x18c>
        putc(fd, *ap);
    4225:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4228:	8b 00                	mov    (%eax),%eax
    422a:	0f be c0             	movsbl %al,%eax
    422d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4231:	8b 45 08             	mov    0x8(%ebp),%eax
    4234:	89 04 24             	mov    %eax,(%esp)
    4237:	e8 29 fd ff ff       	call   3f65 <putc>
        ap++;
    423c:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4240:	eb 45                	jmp    4287 <printf+0x1d1>
      } else if(c == '%'){
    4242:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    4246:	75 17                	jne    425f <printf+0x1a9>
        putc(fd, c);
    4248:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    424b:	0f be c0             	movsbl %al,%eax
    424e:	89 44 24 04          	mov    %eax,0x4(%esp)
    4252:	8b 45 08             	mov    0x8(%ebp),%eax
    4255:	89 04 24             	mov    %eax,(%esp)
    4258:	e8 08 fd ff ff       	call   3f65 <putc>
    425d:	eb 28                	jmp    4287 <printf+0x1d1>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    425f:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    4266:	00 
    4267:	8b 45 08             	mov    0x8(%ebp),%eax
    426a:	89 04 24             	mov    %eax,(%esp)
    426d:	e8 f3 fc ff ff       	call   3f65 <putc>
        putc(fd, c);
    4272:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4275:	0f be c0             	movsbl %al,%eax
    4278:	89 44 24 04          	mov    %eax,0x4(%esp)
    427c:	8b 45 08             	mov    0x8(%ebp),%eax
    427f:	89 04 24             	mov    %eax,(%esp)
    4282:	e8 de fc ff ff       	call   3f65 <putc>
      }
      state = 0;
    4287:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    428e:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    4292:	8b 55 0c             	mov    0xc(%ebp),%edx
    4295:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4298:	01 d0                	add    %edx,%eax
    429a:	0f b6 00             	movzbl (%eax),%eax
    429d:	84 c0                	test   %al,%al
    429f:	0f 85 33 fe ff ff    	jne    40d8 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    42aa:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    42ad:	8b 45 08             	mov    0x8(%ebp),%eax
    42b0:	83 e8 08             	sub    $0x8,%eax
    42b3:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    42b6:	a1 48 64 00 00       	mov    0x6448,%eax
    42bb:	89 45 fc             	mov    %eax,-0x4(%ebp)
    42be:	eb 24                	jmp    42e4 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    42c0:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42c3:	8b 00                	mov    (%eax),%eax
    42c5:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    42c8:	77 12                	ja     42dc <free+0x35>
    42ca:	8b 45 f8             	mov    -0x8(%ebp),%eax
    42cd:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    42d0:	77 24                	ja     42f6 <free+0x4f>
    42d2:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42d5:	8b 00                	mov    (%eax),%eax
    42d7:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    42da:	77 1a                	ja     42f6 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    42e1:	89 45 fc             	mov    %eax,-0x4(%ebp)
    42e4:	8b 45 f8             	mov    -0x8(%ebp),%eax
    42e7:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    42ea:	76 d4                	jbe    42c0 <free+0x19>
    42ec:	8b 45 fc             	mov    -0x4(%ebp),%eax
    42ef:	8b 00                	mov    (%eax),%eax
    42f1:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    42f4:	76 ca                	jbe    42c0 <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    42f6:	8b 45 f8             	mov    -0x8(%ebp),%eax
    42f9:	8b 40 04             	mov    0x4(%eax),%eax
    42fc:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    4303:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4306:	01 c2                	add    %eax,%edx
    4308:	8b 45 fc             	mov    -0x4(%ebp),%eax
    430b:	8b 00                	mov    (%eax),%eax
    430d:	39 c2                	cmp    %eax,%edx
    430f:	75 24                	jne    4335 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    4311:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4314:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    432c:	8b 10                	mov    (%eax),%edx
    432e:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4331:	89 10                	mov    %edx,(%eax)
    4333:	eb 0a                	jmp    433f <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    4342:	8b 40 04             	mov    0x4(%eax),%eax
    4345:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    434c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    434f:	01 d0                	add    %edx,%eax
    4351:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4354:	75 20                	jne    4376 <free+0xcf>
    p->s.size += bp->s.size;
    4356:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4359:	8b 50 04             	mov    0x4(%eax),%edx
    435c:	8b 45 f8             	mov    -0x8(%ebp),%eax
    435f:	8b 40 04             	mov    0x4(%eax),%eax
    4362:	01 c2                	add    %eax,%edx
    4364:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4367:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    436a:	8b 45 f8             	mov    -0x8(%ebp),%eax
    436d:	8b 10                	mov    (%eax),%edx
    436f:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4372:	89 10                	mov    %edx,(%eax)
    4374:	eb 08                	jmp    437e <free+0xd7>
  } else
    p->s.ptr = bp;
    4376:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4379:	8b 55 f8             	mov    -0x8(%ebp),%edx
    437c:	89 10                	mov    %edx,(%eax)
  freep = p;
    437e:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4381:	a3 48 64 00 00       	mov    %eax,0x6448
}
    4386:	c9                   	leave  
    4387:	c3                   	ret    
...
{
    4388:	55                   	push   %ebp
    4389:	89 e5                	mov    %esp,%ebp
    438b:	83 ec 28             	sub    $0x28,%esp
  char *p;
  Header *hp;

  if(nu < 4096)
    438e:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4395:	77 07                	ja     439e <morecore+0x16>
    nu = 4096;
    4397:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    439e:	8b 45 08             	mov    0x8(%ebp),%eax
    43a1:	c1 e0 03             	shl    $0x3,%eax
    43a4:	89 04 24             	mov    %eax,(%esp)
    43a7:	e8 91 fb ff ff       	call   3f3d <sbrk>
    43ac:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    43af:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    43b3:	75 07                	jne    43bc <morecore+0x34>
    return 0;
    43b5:	b8 00 00 00 00       	mov    $0x0,%eax
    43ba:	eb 22                	jmp    43de <morecore+0x56>
  hp = (Header*)p;
  ...
  free((void*)(hp + 1));
    ...
    43d1:	89 04 24             	mov    %eax,(%esp)
    43d4:	e8 ce fe ff ff       	call   42a7 <free>
  return freep;
    43d9:	a1 48 64 00 00       	mov    0x6448,%eax
}
    43de:	c9                   	leave  
    43df:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    43e3:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    43e6:	8b 45 08             	mov    0x8(%ebp),%eax
    43e9:	83 c0 07             	add    $0x7,%eax
    43ec:	c1 e8 03             	shr    $0x3,%eax
    43ef:	83 c0 01             	add    $0x1,%eax
    43f2:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    43f5:	a1 48 64 00 00       	mov    0x6448,%eax
    43fa:	89 45 f0             	mov    %eax,-0x10(%ebp)
    43fd:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4401:	75 23                	jne    4426 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    4403:	c7 45 f0 40 64 00 00 	movl   $0x6440,-0x10(%ebp)
    440a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    440d:	a3 48 64 00 00       	mov    %eax,0x6448
    4412:	a1 48 64 00 00       	mov    0x6448,%eax
    4417:	a3 40 64 00 00       	mov    %eax,0x6440
    base.s.size = 0;
    441c:	c7 05 44 64 00 00 00 	movl   $0x0,0x6444
    4423:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    4426:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4429:	8b 00                	mov    (%eax),%eax
    442b:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    442e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4431:	8b 40 04             	mov    0x4(%eax),%eax
    4434:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4437:	72 4d                	jb     4486 <malloc+0xa6>
      if(p->s.size == nunits)
    4439:	8b 45 f4             	mov    -0xc(%ebp),%eax
    443c:	8b 40 04             	mov    0x4(%eax),%eax
    443f:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    4442:	75 0c                	jne    4450 <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    4444:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4447:	8b 10                	mov    (%eax),%edx
    4449:	8b 45 f0             	mov    -0x10(%ebp),%eax
    444c:	89 10                	mov    %edx,(%eax)
    444e:	eb 26                	jmp    4476 <malloc+0x96>
      else {
        p->s.size -= nunits;
    4450:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4453:	8b 40 04             	mov    0x4(%eax),%eax
    4456:	2b 45 ec             	sub    -0x14(%ebp),%eax
    4459:	89 c2                	mov    %eax,%edx
    445b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    445e:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    4461:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4464:	8b 40 04             	mov    0x4(%eax),%eax
    4467:	c1 e0 03             	shl    $0x3,%eax
    446a:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    446d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4470:	8b 55 ec             	mov    -0x14(%ebp),%edx
    4473:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4476:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4479:	a3 48 64 00 00       	mov    %eax,0x6448
      return (void*)(p + 1);
    447e:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4481:	83 c0 08             	add    $0x8,%eax
    4484:	eb 38                	jmp    44be <malloc+0xde>
    }
    if(p == freep)
    4486:	a1 48 64 00 00       	mov    0x6448,%eax
    448b:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    448e:	75 1b                	jne    44ab <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    4490:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4493:	89 04 24             	mov    %eax,(%esp)
    4496:	e8 ed fe ff ff       	call   4388 <morecore>
    449b:	89 45 f4             	mov    %eax,-0xc(%ebp)
    449e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    44a2:	75 07                	jne    44ab <malloc+0xcb>
        return 0;
    44a4:	b8 00 00 00 00       	mov    $0x0,%eax
    44a9:	eb 13                	jmp    44be <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    44ab:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44ae:	89 45 f0             	mov    %eax,-0x10(%ebp)
    44b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44b4:	8b 00                	mov    (%eax),%eax
    44b6:	89 45 f4             	mov    %eax,-0xc(%ebp)
      return (void*)(p + 1);
    }
    if(p == freep)
      if((p = morecore(nunits)) == 0)
    ...
    44b9:	e9 70 ff ff ff       	jmp    442e <malloc+0x4e>
}
    44be:	c9                   	leave  
    44bf:	c3                   	ret    
