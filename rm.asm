...
main(int argc, char *argv[])
{
  ...
  66:	c7 44 24 04 16 09 00 	movl   $0x916,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 420:	0f b6 80 9c 0b 00 00 	movzbl 0xb9c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 62c:	75 09                	jne    637 <printf+0x13f>
          s = "(null)";
 62e:	c7 45 f4 2f 09 00 00 	movl   $0x92f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f8:	a1 b8 0b 00 00       	mov    0xbb8,%eax
...
free(void *ap)
{
 ...
 7c3:	a3 b8 0b 00 00       	mov    %eax,0xbb8
}
 7c8:	c9                   	leave  
 7c9:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 816:	e8 ce fe ff ff       	call   6e9 <free>
  return freep;
 81b:	a1 b8 0b 00 00       	mov    0xbb8,%eax
}
 820:	c9                   	leave  
 821:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 834:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 837:	a1 b8 0b 00 00       	mov    0xbb8,%eax
 83c:	89 45 f0             	mov    %eax,-0x10(%ebp)
 83f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 843:	75 23                	jne    868 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 845:	c7 45 f0 b0 0b 00 00 	movl   $0xbb0,-0x10(%ebp)
 84c:	8b 45 f0             	mov    -0x10(%ebp),%eax
 84f:	a3 b8 0b 00 00       	mov    %eax,0xbb8
 854:	a1 b8 0b 00 00       	mov    0xbb8,%eax
 859:	a3 b0 0b 00 00       	mov    %eax,0xbb0
    base.s.size = 0;
 85e:	c7 05 b4 0b 00 00 00 	movl   $0x0,0xbb4
 865:	00 00 00 
  }
 ...
 8bb:	a3 b8 0b 00 00       	mov    %eax,0xbb8
      return (void*)(p + 1);
 ...
 8c6:	eb 38                	jmp    900 <malloc+0xde>
    ...
    if(p == freep)
 8c8:	a1 b8 0b 00 00       	mov    0xbb8,%eax
