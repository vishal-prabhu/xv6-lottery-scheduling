...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      1b:	8b 04 85 98 15 00 00 	mov    0x1598(,%eax,4),%eax
      22:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
      24:	c7 04 24 6c 15 00 00 	movl   $0x156c,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      67:	c7 44 24 04 73 15 00 	movl   $0x1573,0x4(%esp)
      6e:	00 
      6f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      76:	e8 e7 10 00 00       	call   1162 <printf>
    break;
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ba:	c7 44 24 04 83 15 00 	movl   $0x1583,0x4(%esp)
      c1:	00 
      c2:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
      c9:	e8 94 10 00 00       	call   1162 <printf>
      exit();
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     12e:	79 0c                	jns    13c <runcmd+0x13c>
      panic("pipe");
     130:	c7 04 24 93 15 00 00 	movl   $0x1593,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     211:	c7 44 24 04 b0 15 00 	movl   $0x15b0,0x4(%esp)
     218:	00 
     219:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     220:	e8 3d 0f 00 00       	call   1162 <printf>
  memset(buf, 0, nbuf);
     ...
     287:	eb 1f                	jmp    2a8 <main+0x3f>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     290:	00 
     291:	c7 04 24 b3 15 00 00 	movl   $0x15b3,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     2ad:	0f b6 05 40 1b 00 00 	movzbl 0x1b40,%eax
     2b4:	3c 63                	cmp    $0x63,%al
     2b6:	75 5c                	jne    314 <main+0xab>
     2b8:	0f b6 05 41 1b 00 00 	movzbl 0x1b41,%eax
     2bf:	3c 64                	cmp    $0x64,%al
     2c1:	75 51                	jne    314 <main+0xab>
     2c3:	0f b6 05 42 1b 00 00 	movzbl 0x1b42,%eax
     2ca:	3c 20                	cmp    $0x20,%al
     2cc:	75 46                	jne    314 <main+0xab>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     2ce:	c7 04 24 40 1b 00 00 	movl   $0x1b40,(%esp)
     2d5:	e8 b3 0a 00 00       	call   d8d <strlen>
     2da:	83 e8 01             	sub    $0x1,%eax
     2dd:	c6 80 40 1b 00 00 00 	movb   $0x0,0x1b40(%eax)
      if(chdir(buf+3) < 0)
     2e4:	c7 04 24 43 1b 00 00 	movl   $0x1b43,(%esp)
     2eb:	e8 e1 0c 00 00       	call   fd1 <chdir>
     2f0:	85 c0                	test   %eax,%eax
     2f2:	79 1e                	jns    312 <main+0xa9>
        printf(2, "cannot cd %s\n", buf+3);
     2f4:	c7 44 24 08 43 1b 00 	movl   $0x1b43,0x8(%esp)
     2fb:	00 
     2fc:	c7 44 24 04 bb 15 00 	movl   $0x15bb,0x4(%esp)
     303:	00 
     304:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     30b:	e8 52 0e 00 00       	call   1162 <printf>
      continue;
    ...
    if(fork1() == 0)
     ...
     31b:	75 14                	jne    331 <main+0xc8>
      runcmd(parsecmd(buf));
     31d:	c7 04 24 40 1b 00 00 	movl   $0x1b40,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     33d:	00 
     33e:	c7 04 24 40 1b 00 00 	movl   $0x1b40,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     364:	c7 44 24 04 c9 15 00 	movl   $0x15c9,0x4(%esp)
     36b:	00 
     36c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     373:	e8 ea 0d 00 00       	call   1162 <printf>
  exit();
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     391:	c7 04 24 cd 15 00 00 	movl   $0x15cd,(%esp)
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3af:	e8 d8 10 00 00       	call   148c <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3ed:	e8 9a 10 00 00       	call   148c <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     458:	e8 2f 10 00 00       	call   148c <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4a8:	e8 df 0f 00 00       	call   148c <malloc>
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     4f8:	e8 8f 0f 00 00       	call   148c <malloc>
     ...
     542:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     55b:	c7 04 24 04 1b 00 00 	movl   $0x1b04,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     605:	c7 04 24 04 1b 00 00 	movl   $0x1b04,(%esp)
     ...
     622:	c7 04 24 0a 1b 00 00 	movl   $0x1b0a,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     660:	c7 04 24 04 1b 00 00 	movl   $0x1b04,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a6:	c7 04 24 04 1b 00 00 	movl   $0x1b04,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     721:	c7 44 24 08 d2 15 00 	movl   $0x15d2,0x8(%esp)
     728:	00 
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     74a:	c7 44 24 04 d3 15 00 	movl   $0x15d3,0x4(%esp)
     751:	00 
     752:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     759:	e8 04 0a 00 00       	call   1162 <printf>
    panic("syntax");
     75e:	c7 04 24 e2 15 00 00 	movl   $0x15e2,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     7cb:	c7 44 24 08 e9 15 00 	movl   $0x15e9,0x8(%esp)
     7d2:	00 
  ...
  if(peek(ps, es, ";")){
     7e9:	c7 44 24 08 eb 15 00 	movl   $0x15eb,0x8(%esp)
     7f0:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     86d:	c7 44 24 08 ed 15 00 	movl   $0x15ed,0x8(%esp)
     874:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     92b:	c7 04 24 ef 15 00 00 	movl   $0x15ef,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     9d7:	c7 44 24 08 0c 16 00 	movl   $0x160c,0x8(%esp)
     9de:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     a04:	c7 44 24 08 0f 16 00 	movl   $0x160f,0x8(%esp)
     a0b:	00 
    ...
    panic("parseblock");
     a22:	c7 04 24 11 16 00 00 	movl   $0x1611,(%esp)
  ...
  if(!peek(ps, es, ")"))
     a65:	c7 44 24 08 1c 16 00 	movl   $0x161c,0x8(%esp)
     a6c:	00 
    ...
    panic("syntax - missing )");
     a83:	c7 04 24 1e 16 00 00 	movl   $0x161e,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ad8:	c7 44 24 08 0f 16 00 	movl   $0x160f,0x8(%esp)
     adf:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     b75:	74 0c                	je     b83 <parseexec+0xb1>
      panic("syntax");
     b77:	c7 04 24 e2 15 00 00 	movl   $0x15e2,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     ba8:	7e 0c                	jle    bb6 <parseexec+0xe4>
      panic("too many args");
     baa:	c7 04 24 31 16 00 00 	movl   $0x1631,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     bd2:	c7 44 24 08 3f 16 00 	movl   $0x163f,0x8(%esp)
     bd9:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     c3c:	8b 04 85 44 16 00 00 	mov    0x1644(,%eax,4),%eax
     c43:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
putc(int fd, char c)
{
    ...
    1014:	83 ec 18             	sub    $0x18,%esp
    1017:	8b 45 0c             	mov    0xc(%ebp),%eax
    101a:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    101d:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    1024:	00 
    1025:	8d 45 f4             	lea    -0xc(%ebp),%eax
    1028:	89 44 24 04          	mov    %eax,0x4(%esp)
    102c:	8b 45 08             	mov    0x8(%ebp),%eax
    102f:	89 04 24             	mov    %eax,(%esp)
    1032:	e8 4a ff ff ff       	call   f81 <write>
}
    1037:	c9                   	leave  
    1038:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    1041:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    1048:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    104c:	74 17                	je     1065 <printint+0x2c>
    104e:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    1052:	79 11                	jns    1065 <printint+0x2c>
    neg = 1;
    1054:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    105b:	8b 45 0c             	mov    0xc(%ebp),%eax
    105e:	f7 d8                	neg    %eax
    1060:	89 45 ec             	mov    %eax,-0x14(%ebp)
    1063:	eb 06                	jmp    106b <printint+0x32>
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
    1072:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    1075:	8d 41 01             	lea    0x1(%ecx),%eax
    1078:	89 45 f4             	mov    %eax,-0xc(%ebp)
    107b:	8b 5d 10             	mov    0x10(%ebp),%ebx
    107e:	8b 45 ec             	mov    -0x14(%ebp),%eax
    1081:	ba 00 00 00 00       	mov    $0x0,%edx
    1086:	f7 f3                	div    %ebx
    1088:	89 d0                	mov    %edx,%eax
    108a:	0f b6 80 12 1b 00 00 	movzbl 0x1b12(%eax),%eax
    1091:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    1095:	8b 75 10             	mov    0x10(%ebp),%esi
    1098:	8b 45 ec             	mov    -0x14(%ebp),%eax
    109b:	ba 00 00 00 00       	mov    $0x0,%edx
    10a0:	f7 f6                	div    %esi
    10a2:	89 45 ec             	mov    %eax,-0x14(%ebp)
    10a5:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    10a9:	75 c7                	jne    1072 <printint+0x39>
  if(neg)
    10ab:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    10af:	74 10                	je     10c1 <printint+0x88>
    buf[i++] = '-';
    10b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    10b4:	8d 50 01             	lea    0x1(%eax),%edx
    10b7:	89 55 f4             	mov    %edx,-0xc(%ebp)
    10ba:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    10bf:	eb 1f                	jmp    10e0 <printint+0xa7>
    ...
    10db:	e8 31 ff ff ff       	call   1011 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
printlong(int fd, unsigned long long xx, int base, int sgn)
{
    ...
    10f4:	83 ec 38             	sub    $0x38,%esp
    10f7:	8b 45 0c             	mov    0xc(%ebp),%eax
    10fa:	89 45 e0             	mov    %eax,-0x20(%ebp)
    10fd:	8b 45 10             	mov    0x10(%ebp),%eax
    1100:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    // Force hexadecimal
    uint upper, lower;
    upper = xx >> 32;
    1103:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1106:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    1109:	89 d0                	mov    %edx,%eax
    110b:	31 d2                	xor    %edx,%edx
    110d:	89 45 f4             	mov    %eax,-0xc(%ebp)
    lower = xx & 0xffffffff;
    1110:	8b 45 e0             	mov    -0x20(%ebp),%eax
    1113:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(upper) printint(fd, upper, 16, 0);
    1116:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    111a:	74 22                	je     113e <printlong+0x4d>
    111c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    111f:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    1126:	00 
    1127:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    112e:	00 
    112f:	89 44 24 04          	mov    %eax,0x4(%esp)
    1133:	8b 45 08             	mov    0x8(%ebp),%eax
    1136:	89 04 24             	mov    %eax,(%esp)
    1139:	e8 fb fe ff ff       	call   1039 <printint>
    printint(fd, lower, 16, 0);
    113e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1141:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    1148:	00 
    1149:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    1150:	00 
    1151:	89 44 24 04          	mov    %eax,0x4(%esp)
    1155:	8b 45 08             	mov    0x8(%ebp),%eax
    1158:	89 04 24             	mov    %eax,(%esp)
    115b:	e8 d9 fe ff ff       	call   1039 <printint>
}
    1160:	c9                   	leave  
    1161:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
    116f:	8d 45 0c             	lea    0xc(%ebp),%eax
    1172:	83 c0 04             	add    $0x4,%eax
    1175:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    1178:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    117f:	e9 ba 01 00 00       	jmp    133e <printf+0x1dc>
    c = fmt[i] & 0xff;
    ...
    1192:	25 ff 00 00 00       	and    $0xff,%eax
    1197:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    119a:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    119e:	75 2c                	jne    11cc <printf+0x6a>
      if(c == '%'){
    11a0:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    11a4:	75 0c                	jne    11b2 <printf+0x50>
        state = '%';
    11a6:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    11ad:	e9 88 01 00 00       	jmp    133a <printf+0x1d8>
      } else {
        putc(fd, c);
    ...
    11c2:	e8 4a fe ff ff       	call   1011 <putc>
    11c7:	e9 6e 01 00 00       	jmp    133a <printf+0x1d8>
      }
    } else if(state == '%'){
    11cc:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    11d0:	0f 85 64 01 00 00    	jne    133a <printf+0x1d8>
      if(c == 'd'){
    11d6:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    11da:	75 2d                	jne    1209 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    11dc:	8b 45 e8             	mov    -0x18(%ebp),%eax
    11df:	8b 00                	mov    (%eax),%eax
    11e1:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    11e8:	00 
    11e9:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    11f0:	00 
    11f1:	89 44 24 04          	mov    %eax,0x4(%esp)
    11f5:	8b 45 08             	mov    0x8(%ebp),%eax
    11f8:	89 04 24             	mov    %eax,(%esp)
    11fb:	e8 39 fe ff ff       	call   1039 <printint>
        ap++;
    1200:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1204:	e9 2a 01 00 00       	jmp    1333 <printf+0x1d1>
      } else if(c == 'l') {
    1209:	83 7d e4 6c          	cmpl   $0x6c,-0x1c(%ebp)
    120d:	75 38                	jne    1247 <printf+0xe5>
        printlong(fd, *(unsigned long long *)ap, 10, 0);
    120f:	8b 45 e8             	mov    -0x18(%ebp),%eax
    1212:	8b 50 04             	mov    0x4(%eax),%edx
    1215:	8b 00                	mov    (%eax),%eax
    1217:	c7 44 24 10 00 00 00 	movl   $0x0,0x10(%esp)
    121e:	00 
    121f:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
    1226:	00 
    1227:	89 44 24 04          	mov    %eax,0x4(%esp)
    122b:	89 54 24 08          	mov    %edx,0x8(%esp)
    122f:	8b 45 08             	mov    0x8(%ebp),%eax
    1232:	89 04 24             	mov    %eax,(%esp)
    1235:	e8 b7 fe ff ff       	call   10f1 <printlong>
        // long longs take up 2 argument slots
        ap++;
    123a:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        ap++;
    123e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    1242:	e9 ec 00 00 00       	jmp    1333 <printf+0x1d1>
      } else if(c == 'x' || c == 'p'){
    1247:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    124b:	74 06                	je     1253 <printf+0xf1>
    124d:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    1251:	75 2d                	jne    1280 <printf+0x11e>
        printint(fd, *ap, 16, 0);
    ...
    1272:	e8 c2 fd ff ff       	call   1039 <printint>
        ap++;
    1277:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    127b:	e9 b3 00 00 00       	jmp    1333 <printf+0x1d1>
      } else if(c == 's'){
    1280:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    1284:	75 45                	jne    12cb <printf+0x169>
        s = (char*)*ap;
    ...
    1296:	75 09                	jne    12a1 <printf+0x13f>
          s = "(null)";
    1298:	c7 45 f4 5c 16 00 00 	movl   $0x165c,-0xc(%ebp)
        while(*s != 0){
    129f:	eb 1e                	jmp    12bf <printf+0x15d>
    12a1:	eb 1c                	jmp    12bf <printf+0x15d>
          putc(fd, *s);
    ...
    12b6:	e8 56 fd ff ff       	call   1011 <putc>
          s++;
    12bb:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    12c7:	75 da                	jne    12a3 <printf+0x141>
    12c9:	eb 68                	jmp    1333 <printf+0x1d1>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    12cb:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    12cf:	75 1d                	jne    12ee <printf+0x18c>
        putc(fd, *ap);
    12d1:	8b 45 e8             	mov    -0x18(%ebp),%eax
    12d4:	8b 00                	mov    (%eax),%eax
    12d6:	0f be c0             	movsbl %al,%eax
    12d9:	89 44 24 04          	mov    %eax,0x4(%esp)
    12dd:	8b 45 08             	mov    0x8(%ebp),%eax
    12e0:	89 04 24             	mov    %eax,(%esp)
    12e3:	e8 29 fd ff ff       	call   1011 <putc>
        ap++;
    12e8:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    12ec:	eb 45                	jmp    1333 <printf+0x1d1>
      } else if(c == '%'){
    12ee:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    12f2:	75 17                	jne    130b <printf+0x1a9>
        putc(fd, c);
    ...
    1304:	e8 08 fd ff ff       	call   1011 <putc>
    1309:	eb 28                	jmp    1333 <printf+0x1d1>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    130b:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    1312:	00 
    1313:	8b 45 08             	mov    0x8(%ebp),%eax
    1316:	89 04 24             	mov    %eax,(%esp)
    1319:	e8 f3 fc ff ff       	call   1011 <putc>
        putc(fd, c);
    131e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    1321:	0f be c0             	movsbl %al,%eax
    1324:	89 44 24 04          	mov    %eax,0x4(%esp)
    1328:	8b 45 08             	mov    0x8(%ebp),%eax
    132b:	89 04 24             	mov    %eax,(%esp)
    132e:	e8 de fc ff ff       	call   1011 <putc>
      }
      state = 0;
    1333:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    133a:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    ...
    134b:	0f 85 33 fe ff ff    	jne    1184 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    1356:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    1359:	8b 45 08             	mov    0x8(%ebp),%eax
    135c:	83 e8 08             	sub    $0x8,%eax
    135f:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1362:	a1 ac 1b 00 00       	mov    0x1bac,%eax
    1367:	89 45 fc             	mov    %eax,-0x4(%ebp)
    136a:	eb 24                	jmp    1390 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    136c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    136f:	8b 00                	mov    (%eax),%eax
    1371:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1374:	77 12                	ja     1388 <free+0x35>
    1376:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1379:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    137c:	77 24                	ja     13a2 <free+0x4f>
    137e:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1381:	8b 00                	mov    (%eax),%eax
    1383:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    1386:	77 1a                	ja     13a2 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1393:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    1396:	76 d4                	jbe    136c <free+0x19>
    1398:	8b 45 fc             	mov    -0x4(%ebp),%eax
    139b:	8b 00                	mov    (%eax),%eax
    139d:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    13a0:	76 ca                	jbe    136c <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    13a2:	8b 45 f8             	mov    -0x8(%ebp),%eax
    13a5:	8b 40 04             	mov    0x4(%eax),%eax
    13a8:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    13af:	8b 45 f8             	mov    -0x8(%ebp),%eax
    13b2:	01 c2                	add    %eax,%edx
    13b4:	8b 45 fc             	mov    -0x4(%ebp),%eax
    13b7:	8b 00                	mov    (%eax),%eax
    13b9:	39 c2                	cmp    %eax,%edx
    13bb:	75 24                	jne    13e1 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    13bd:	8b 45 f8             	mov    -0x8(%ebp),%eax
    13c0:	8b 50 04             	mov    0x4(%eax),%edx
    13c3:	8b 45 fc             	mov    -0x4(%ebp),%eax
    13c6:	8b 00                	mov    (%eax),%eax
    13c8:	8b 40 04             	mov    0x4(%eax),%eax
    13cb:	01 c2                	add    %eax,%edx
    13cd:	8b 45 f8             	mov    -0x8(%ebp),%eax
    13d0:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    13d3:	8b 45 fc             	mov    -0x4(%ebp),%eax
    13d6:	8b 00                	mov    (%eax),%eax
    13d8:	8b 10                	mov    (%eax),%edx
    13da:	8b 45 f8             	mov    -0x8(%ebp),%eax
    13dd:	89 10                	mov    %edx,(%eax)
    13df:	eb 0a                	jmp    13eb <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
  ...
  if(p + p->s.size == bp){
    ...
    13ee:	8b 40 04             	mov    0x4(%eax),%eax
    13f1:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    13f8:	8b 45 fc             	mov    -0x4(%ebp),%eax
    13fb:	01 d0                	add    %edx,%eax
    13fd:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    1400:	75 20                	jne    1422 <free+0xcf>
    p->s.size += bp->s.size;
    1402:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1405:	8b 50 04             	mov    0x4(%eax),%edx
    ...
    p->s.ptr = bp->s.ptr;
    1416:	8b 45 f8             	mov    -0x8(%ebp),%eax
    1419:	8b 10                	mov    (%eax),%edx
    141b:	8b 45 fc             	mov    -0x4(%ebp),%eax
    141e:	89 10                	mov    %edx,(%eax)
    1420:	eb 08                	jmp    142a <free+0xd7>
  } else
    p->s.ptr = bp;
    1422:	8b 45 fc             	mov    -0x4(%ebp),%eax
    1425:	8b 55 f8             	mov    -0x8(%ebp),%edx
    1428:	89 10                	mov    %edx,(%eax)
  freep = p;
    142a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    142d:	a3 ac 1b 00 00       	mov    %eax,0x1bac
}
    1432:	c9                   	leave  
    1433:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    143a:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    1441:	77 07                	ja     144a <morecore+0x16>
    nu = 4096;
    1443:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    144a:	8b 45 08             	mov    0x8(%ebp),%eax
    144d:	c1 e0 03             	shl    $0x3,%eax
    1450:	89 04 24             	mov    %eax,(%esp)
    1453:	e8 91 fb ff ff       	call   fe9 <sbrk>
    1458:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    145b:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    145f:	75 07                	jne    1468 <morecore+0x34>
    return 0;
    1461:	b8 00 00 00 00       	mov    $0x0,%eax
    1466:	eb 22                	jmp    148a <morecore+0x56>
  hp = (Header*)p;
    1468:	8b 45 f4             	mov    -0xc(%ebp),%eax
    146b:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    146e:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1471:	8b 55 08             	mov    0x8(%ebp),%edx
    1474:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    1477:	8b 45 f0             	mov    -0x10(%ebp),%eax
    147a:	83 c0 08             	add    $0x8,%eax
    147d:	89 04 24             	mov    %eax,(%esp)
    1480:	e8 ce fe ff ff       	call   1353 <free>
  return freep;
    1485:	a1 ac 1b 00 00       	mov    0x1bac,%eax
}
    148a:	c9                   	leave  
    148b:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    ...
    1495:	83 c0 07             	add    $0x7,%eax
    1498:	c1 e8 03             	shr    $0x3,%eax
    149b:	83 c0 01             	add    $0x1,%eax
    149e:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    14a1:	a1 ac 1b 00 00       	mov    0x1bac,%eax
    14a6:	89 45 f0             	mov    %eax,-0x10(%ebp)
    14a9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    14ad:	75 23                	jne    14d2 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    14af:	c7 45 f0 a4 1b 00 00 	movl   $0x1ba4,-0x10(%ebp)
    14b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
    14b9:	a3 ac 1b 00 00       	mov    %eax,0x1bac
    14be:	a1 ac 1b 00 00       	mov    0x1bac,%eax
    14c3:	a3 a4 1b 00 00       	mov    %eax,0x1ba4
    base.s.size = 0;
    14c8:	c7 05 a8 1b 00 00 00 	movl   $0x0,0x1ba8
    14cf:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    14e0:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    14e3:	72 4d                	jb     1532 <malloc+0xa6>
      if(p->s.size == nunits)
    14e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    14e8:	8b 40 04             	mov    0x4(%eax),%eax
    14eb:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    14ee:	75 0c                	jne    14fc <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    14f0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    14f3:	8b 10                	mov    (%eax),%edx
    14f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    14f8:	89 10                	mov    %edx,(%eax)
    14fa:	eb 26                	jmp    1522 <malloc+0x96>
      else {
        p->s.size -= nunits;
    14fc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    14ff:	8b 40 04             	mov    0x4(%eax),%eax
    1502:	2b 45 ec             	sub    -0x14(%ebp),%eax
    ...
    1513:	c1 e0 03             	shl    $0x3,%eax
    1516:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    1519:	8b 45 f4             	mov    -0xc(%ebp),%eax
    151c:	8b 55 ec             	mov    -0x14(%ebp),%edx
    151f:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    1522:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1525:	a3 ac 1b 00 00       	mov    %eax,0x1bac
      return (void*)(p + 1);
    152a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    152d:	83 c0 08             	add    $0x8,%eax
    1530:	eb 38                	jmp    156a <malloc+0xde>
    }
    if(p == freep)
    1532:	a1 ac 1b 00 00       	mov    0x1bac,%eax
    1537:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    153a:	75 1b                	jne    1557 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    153c:	8b 45 ec             	mov    -0x14(%ebp),%eax
    153f:	89 04 24             	mov    %eax,(%esp)
    1542:	e8 ed fe ff ff       	call   1434 <morecore>
    1547:	89 45 f4             	mov    %eax,-0xc(%ebp)
    154a:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    154e:	75 07                	jne    1557 <malloc+0xcb>
        return 0;
    1550:	b8 00 00 00 00       	mov    $0x0,%eax
    1555:	eb 13                	jmp    156a <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    155a:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    1565:	e9 70 ff ff ff       	jmp    14da <malloc+0x4e>
}
    156a:	c9                   	leave  
    156b:	c3                   	ret    
